...
No necesitamos todos los efectos en el modelo porque sabemos que hay equivalencias gracias a las parametrizaciones.
...
-   Si no se rechaza la hipótesis: No hay interacción y se quieren comparar todos los pares de un factor se pueden comparar usando Tukey (si el efecto del factor es significativo)

-   Si hay interacción quiere decir que no puedo comparar los factores independientemente de cada uno de ellos. En este caso hay que tomar diferentes consideraciones.
